...
function LinkTile({ title, desc, href }) {
  return (
    ...
    >
      <div className="font-semibold text-[#005EB8]">{title}</div>
      {desc && <div className="mt-1 text-sm text-[#005EB8]">{desc}</div>}
    </a>
  );
}
...
export default function Home() {
  return (
    <div className="space-y-6">
      {/* Welcome panel */}
      <Card className="p-6">
        <h1 className="text-3xl font-bold text-[#005EB8]">Welcome to Malthouse Surgery</h1>
        <p className="mt-3 leading-relaxed text-[#005EB8]">
      ...
      {/* Make a Request */}
      <section>
        <h2 className="mb-3 text-lg font-semibold text-[#005EB8]">Make a Request</h2>
      ...
      <Card className="p-6 bg-yellow-50 ring-yellow-100">
        <h3 className="text-lg font-semibold text-[#005EB8]">Flu Vaccination Clinics</h3>
        <p className="mt-1 text-[#005EB8]">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-block mt-3 rounded-lg bg-[#005EB8] px-4 py-2 text-white text-sm font-medium hover:opacity-95"
        >
          Learn more
        </a>
      </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="p-5">
          <div className="font-semibold text-[#005EB8]">Opening</div>
          <div className="mt-1 text-sm text-[#005EB8]">See today’s and holiday closures.</div>
          <a
            href={LINKS.openingHours}
            target="_blank"
            rel="noreferrer"
            className="mt-2 inline-block text-[#005EB8] text-sm font-medium hover:underline"
          >
            View hours
          </a>
        </Card>
        ...
        <Card className="p-5">
          <div className="font-semibold text-[#005EB8]">Call Us</div>
          <div className="mt-1 text-sm text-[#005EB8]">Tap to call the surgery.</div>
          <a
            href={LINKS.callUs}
            className="mt-2 inline-block text-[#005EB8] text-sm font-medium hover:underline"
          >
        ...
        <Card className="p-5">
          <div className="font-semibold text-[#005EB8]">Find Us</div>
          <div className="mt-1 text-sm text-[#005EB8]">View map and directions.</div>
          <a
            href={LINKS.findUs}
            target="_blank"
            rel="noreferrer"
      ...
      {/* Jump to… */}
      <section>
        <h2 className="mb-3 text-lg font-semibold text-[#005EB8]">Jump to…</h2>
